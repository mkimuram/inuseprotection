...
func (gc *InUseProtector) getMetadata(apiVersion, kind, namespace, name string) (metav1.Object, error) {
...
// patch.
func (gc *InUseProtector) patch(item *node, smp []byte, jmp jsonMergePatchFunc) (*metav1.PartialObjectMetadata, error) {
...
func (gc *InUseProtector) deleteOwnerRefJSONMergePatch(item *node, ownerUIDs ...types.UID) ([]byte, error) {
...
// ownerReferences of node.
func (gc *InUseProtector) unblockOwnerReferencesJSONMergePatch(n *node) ([]byte, error) {
